...
<body>
    ...
    <section class="company-banner"
        style="background-image: url('assets/img/assets/team-member-banner.png') !important;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 position-relative z-index-10">
                    ...
                    <p class="mt-3">Chairman, President and Chief Executive Officer</p>
    ...
    <section class="leadership_btns pt-lg-5 pb-lg-5 leaders-img-team">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                ...
                <div class="col-lg-4">
                    <div class="team-socail">
                        <h5>Follow HPIT on social media</h5>
                       <p> <a href="#"><span>
