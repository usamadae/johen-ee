...
<body>
    ...
    <section class="bg-star-left-blue bg-white bg-padding global-scale">
        <div class="container">
            <div class="row">
                <h2 class="sectionHead pb-5">Lorem Ipsum is <span>simply dummy text</span></h2>
                <p class="text-start">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
                    industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type
                    and scrambled it to make a type specimen book. It has survived not only five centuries, but also the
