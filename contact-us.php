...
<body>
    ...
    <section class="leadership_btns bg-white-team pt-lg-5 pb-lg-5 leaders-img-team contact-us">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <h2>Submit your general business inquiry</h2>
                    <p>Please use this form to contact us at HPIT.</p>
                    <form>
                        ...
                        <div class="mt-3">
                            <div class="form-floating">
                                ...
                                <label for="floatingSelect">PHONE NUMBER TYPE</label>
                            </div>
                        </div>
                        ...
                        <div class="mt-3">
                            <div class="form-floating">
                                <select class="form-select" id="floatingSelect"
                                    ...
                                    <option value="GT Store">GT Store</option>
                                    <option value="Sponsorships Inquiry">Sponsorships Inquiry</option>
                                    ...
                                    <option value="Email Subscriptions">Email Subscriptions</option>
                                    <option value="Legal">Legal</option>
                                    <option value="Website Related or Others">Website Related or Others</option>
                                </select>
                                <label for="floatingSelect">INQUIRY TYPE</label>
                            </div>
